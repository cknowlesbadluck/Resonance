...
CI now fails any PR that reintroduces `docs/PORTFOLIO-AUDIT-YYYY-MM-DD-HHMM.md`.
...
5. Quicksilver next code slice after HG (CHR-12 a11y or first bound AI turn). P-T2 aspect prompts shipped (#157).
...
10. Release surface: SideStore evidence, unskip production-smoke, owner prune leftover `docs/*` and `codex/*` branches.
