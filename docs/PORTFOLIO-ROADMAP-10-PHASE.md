...
2. Owner sets `SUPABASE_SERVICE_ROLE_KEY` on resonancenexus only. Exit: `/api/ready` 200. Confirmed missing at 09:00.
...
7. Conduit #125 keyset pagination — DONE (merged 2026-09-26T12:09:14Z onto main `5659a495`).
