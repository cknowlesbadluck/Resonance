...
2. Owner sets `SUPABASE_SERVICE_ROLE_KEY` on resonancenexus only. Exit: `/api/ready` 200. Confirmed missing at 07:09 (env list has URL/anon/auth/project id only).
...
6. Conduit freeze; repair #119/#120 off current main (`eab12882` after #135). Do not merge red.
