...
export interface NexusExecution { id: string; planId: string; status: "planned" | "running" | "waiting" | "completed" | "failed" | "cancelled"; attempts: number; startedAt?: string; completedAt?: string; output?: unknown; error?: string; }
